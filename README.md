[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?branch=develop&project=mosip_nfiq&metric=alert_status)](https://sonarcloud.io/dashboard?branch=develop&id=mosip_nfiq)
# NFIQ
